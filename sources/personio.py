...
@configspec
class OAuth2Personio(OAuth2ClientCredentials):
...
def get_personio_source() -> DltSource:

    oauth = OAuth2Personio(
        access_token_url="https://api.personio.de/v1/auth",
        client_id=dlt.secrets["credentials"]["personio"]["api_client_id"],
        client_secret=dlt.secrets["credentials"]["personio"]["api_client_secret"],
